...
**genpark-product-review-sentiment-analyzer-skill** is a deterministic, zero-dependency Python skill engineered with 100% functional parity for autonomous AI search synthesis, multi-model execution, and agentic workflows.

> **Executive Capability**: Customer review aspect-level sentiment mining engine extracting satisfaction radar breakdown
...
```json
{
  "mcpServers": {
    "genpark-product-review-sentiment-analyzer-skill": {
      "command": "python",
      "args": ["/path/to/genpark-product-review-sentiment-analyzer-skill/mcp_server.py"]
    }
  }
}
```
